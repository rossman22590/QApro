...
git clone https://github.com/gcloudlab/QApro
cd QApro
pnpm install
...
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT pnpm build && OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT pnpm start
